...
echo 'WELCOME TO PEATIO CRYPTOCURRENCY EXCHANGE v1.0 - DEVELOPED BY AANWHS' | boxes -d diamonds -a hcvc
echo -e "\n\n"
echo -e "\033[34;7mWelcome to Peatio Crypto Exchange v1.0 - Build by aanwhs\e[0m "
echo -e "\n\n"
...
echo 'THANKS FOR INSTALLING PEATIO ENJOY !! CONTACT US ON SKYPE : aanwhs | boxes -d peek -a c -s 40x11
echo -e "\n\n"
echo 'Donate us at paypal : paypal.me/aanwhs for future contribution' | boxes -d shell -p a1l2
